...
for (i in 1:nrow(res)){ 
	...
	myCMPlist = c(ampCMPlist, delCMPlist)
      ...
      #### plot all 
      pdf(paste0(out.dir,'/peaks-plots/',g,'_',pk,".pdf"), width=20, height=10, title='', useDingbats=F, onefile=FALSE)
      #png(paste0(out.dir,'/peak-plots/',g,'_',pk,".png"), width=1920, height=960, units = "px", res=300 )
