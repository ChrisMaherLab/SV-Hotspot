...
cat $output_dir/peaks/all_peaks.bed | awk -v OFS="\t" '{print $1,$2,$3,$4,"1000","+",$5,$6,$7,$8;print $1,$2,$3,$4,"1000","-",$5,$6,$7,$8}' > $output_dir/processed_data/all_peaks_with_strands.bed
...
cat $output_dir/processed_data/genes_overlap_with_peaks.tsv $output_dir/processed_data/peaks_with_nearest_genes.tsv > $output_dir/peaks_with_overlap_nearby_genes.tsv
awk -F"\t" '{if($9 ~ "^chr") {print $0}}' $output_dir/peaks_with_overlap_nearby_genes.tsv > $output_dir/peaks_with_overlap_nearby_genes2.tsv
...
if [ "$region_of_interest" != "0" ]; then
  ...
  #intersectBed -wo -a $output_dir/peaks/all_peaks.bed -b $output_dir/processed_data/reg_of_int.bed > $output_dir/peaks_overlap_with_region_of_interest.tsv  
  grep -v "chrom" $region_of_interest | intersectBed -wo -a $output_dir/peaks/all_peaks.bed -b - > $output_dir/peaks_overlap_with_region_of_interest.tsv
