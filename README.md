...
# Please note that to run the tool, the "annotations" directory has to be at the same location where you run the tool.
# This can be done by creating a soft link to the directory using the following command:
